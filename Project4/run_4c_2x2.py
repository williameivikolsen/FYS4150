...
for cycle in cycles:
    ...
    print('E = ', format(E_diff/(analytical_E/L**2),".2E"), 'for number of cycles=', int(cycle))
    print('|M| = ',format(M_diff/(analytical_absM/L**2),".2E"))
    print('C_V = ', format(Cv_diff/(CV/L**2),".2E"))
    print('chi = ', format(chi_diff/(chi/L**2),".2E"))
